...
import {
  Plus, Trash2, Edit2, Check, X, ChefHat, Loader2, Package, Sparkles,
} from "lucide-react";
...
import {
  getPantryItems, deletePantryItem, updatePantryItem,
...
export default function PantryPage() {
  ...
  // ✅ KEY FIX: directly call fetchItems, no intermediate state
  const handleModalSuccess = () => {
    fetchItems();
  };

  // ✅ Read items directly from itemsData, not local state
